...
def test_1_genuine_normal():
    voice = {"ai_voice_probability": 0.03, "voice_integrity_score": 0.97, "confidence": 1.0}
...
def test_5_ai_voice_harmless():
    voice = {"ai_voice_probability": 0.95, "voice_integrity_score": 0.05, "confidence": 1.0}
    intent = {"social_engineering_score": 0.1, "signals": [], "confidence": 1.0}
    action = {"action_risk_score": 0.1, "context_risk_score": 0.1, "signals": [], "confidence": 1.0}
    res = calculate_risk(voice, intent, action)
...
def test_7_normal_benign():
    voice = {"ai_voice_probability": 0.02, "voice_integrity_score": 0.98, "confidence": 1.0}
...
def test_analyze_session_risk_endpoint(mock_transcribe, mock_analyze):
    mock_analyze.return_value = {"ai_voice_probability": 0.03, "voice_integrity_score": 0.97, "confidence": 0.9, "label": "genuine", "model_name": "test"}
